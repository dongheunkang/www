content = addMemberListToObject( {
    ...
    'mp4-clear' : {     initDataType:   'cenc',
                        audio : {   type:   'audio/mp4;codecs="mp4a.40.2"',
                                    path:   './content/audio_aac-lc_128k_dashinit.mp4' },
                        video : {   type:   'video/mp4;codecs="avc1.4d401e"',
                                    path:   './content/video_512x288_h264-360k_clear_dashinit.mp4' }
                    },
    ...
    'mp4-basic' : {     assetId:        'mp4-basic',
                        ...
                        audio : {   type:   'audio/mp4;codecs="mp4a.40.2"',
                                    path:   './content/audio_aac-lc_128k_dashinit.mp4' },
                        video : {   type:   'video/mp4;codecs="avc1.4d401e"',
                                    path:   './content/video_512x288_h264-360k_enc_dashinit.mp4' },
    ...
    'mp4-clear-encrypted' : {
                        ...
                        audio : {   type:   'audio/mp4;codecs="mp4a.40.2"',
                                    path:   './content/audio_aac-lc_128k_dashinit.mp4' },
                        video : {   type:   'video/mp4;codecs="avc1.4d401e"',
                                    path:   './content/video_512x288_h264-360k_clear_enc_dashinit.mp4' },
                        keys :  [ { kid: [ 0xad, 0x13, 0xf9, 0xea, 0x2b, 0xe6, 0x98, 0xb8, 0x75, 0xf5, 0x04, 0xa8, 0xe3, 0xcc, 0xea, 0x64 ],
                                    key: [ 0xbe, 0x7d, 0xf8, 0xa3, 0x66, 0x7a, 0x6a, 0x8f, 0xd5, 0x64, 0xd0, 0xed, 0x81, 0x33, 0x9a, 0x95 ],
                                    initDataType: 'cenc',
                                    initData: '' } ]
    ...
    'mp4-encrypted-clear' : {
                        ...
                        audio : {   type:   'audio/mp4;codecs="mp4a.40.2"',
                                    path:   './content/audio_aac-lc_128k_dashinit.mp4' },
                        video : {   type:   'video/mp4;codecs="avc1.4d401e"',
                                    path:   './content/video_512x288_h264-360k_enc_clear_dashinit.mp4' },
                        keys :  [ { kid: [ 0xad, 0x13, 0xf9, 0xea, 0x2b, 0xe6, 0x98, 0xb8, 0x75, 0xf5, 0x04, 0xa8, 0xe3, 0xcc, 0xea, 0x64 ],
                                    key: [ 0xbe, 0x7d, 0xf8, 0xa3, 0x66, 0x7a, 0x6a, 0x8f, 0xd5, 0x64, 0xd0, 0xed, 0x81, 0x33, 0x9a, 0x95 ],
                                    initDataType: 'cenc',
                                    initData: '' } ]
    ...
    'mp4-av-multikey' : {
                        ...
                        audio:  {   type:   'audio/mp4;codecs="mp4a.40.2"',
                                    path:   './content/audio_aac-lc_128k_enc_dashinit.mp4' },
                        video : {   type:   'video/mp4;codecs="avc1.4d401e"',
                                    path:   './content/video_512x288_h264-360k_enc_dashinit.mp4' },
                        keys :  [ { kid: [ 0xad, 0x13, 0xf9, 0xea, 0x2b, 0xe6, 0x98, 0xb8, 0x75, 0xf5, 0x04, 0xa8, 0xe3, 0xcc, 0xea, 0x64 ],
                                    key: [ 0xbe, 0x7d, 0xf8, 0xa3, 0x66, 0x7a, 0x6a, 0x8f, 0xd5, 0x64, 0xd0, 0xed, 0x81, 0x33, 0x9a, 0x95 ],
    ...
    'mp4-multikey' :  {     assetId:        'mp4-multikey',
                            initDataType:   'cenc',
                            audio:  {   type:   'audio/mp4;codecs="mp4a.40.2"',
                                        path:   './content/audio_aac-lc_128k_2keys_2sess.mp4' },
                            video:  {   type:   'video/mp4;codecs="avc1.4d401e"',
                                        path:   './content/video_512x288_h264-360k_enc_2keys_2sess.mp4' },
    ...
    'mp4-multikey-sequential' : {   assetId:    'mp4-multikey-sequential',
                                    ...
                                    audio: {    type:   'audio/mp4;codecs="mp4a.40.2"',
                                                path:   './content/audio_aac-lc_128k_dashinit.mp4' },
                                    video: {    type:   'video/mp4;codecs="avc1.4d401e"',
                                                path:   './content/video_512x288_h264-360k_multikey_dashinit.mp4' },
